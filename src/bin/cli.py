...
from src.lib.framework import encrypt_file, cyphers
...
parser.add_argument("--msg", metavar="MSG", default="please dont touch the files things might stop working correctly", help="Encoding Message", required=False)
def cli():
